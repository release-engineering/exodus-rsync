...
//
//	mockgen -package walk -destination hash_mock.go hash Hash
//
...
func (mr *MockHashMockRecorder) Sum(b any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockHashMockRecorder) Write(p any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
